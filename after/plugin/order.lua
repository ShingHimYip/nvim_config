...
require("him.plugins.lazygit")
-- require("him.plugins.obsidian")
-- require("him.plugins.liveServer")
-- require("him.plugins.magma-nvim")
require("him.plugins.tailwindcss-colors")
require("him.plugins.indent-blankline")
require("him.plugins.wilder")
-- require("him.plugins.hardtime")
